...
url = "https://mysubdomain.monitoringclient.com/v2.5/computers/?api_key=mMYGREATAPIKEY&group_id=GROUPID&expand[]=plugin_results"
r = requests.get(url)
...
#Print the Info
    ...
    #This get's printed as JSON which is fine, except I want to pull specific things like Malware, Battery etc. How do I do that?
    print(plug) 
    print()